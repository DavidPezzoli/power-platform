...
Note: When you create a patch the system automatcally propose a new solution versioning with *build* number incremented. When you roll up patch solutions,i.e. during a Clone to solution operation, Power Apps propose a new solution versioning with *minor* number incremented.
